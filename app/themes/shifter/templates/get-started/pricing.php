    ...
    <article class="pricing">
      <header class="white pricing__lead">
        ...
        <div class="pricing-toggle">
          <div class="toggle-button annually left-toggle active">Annual</div><!--
          --><div class="button toggle-button monthly right-toggle">Monthly</div>
        </div>
      </header>
      <div class="row">
        ...
        <div class="plans">
          ...
          <div class="plans__item _white black-light">
            ...
            <a class="plans__link btn-link--black-light" href="<?= get_permalink(31) ?>#signup">Sign up</a>
          </div>
